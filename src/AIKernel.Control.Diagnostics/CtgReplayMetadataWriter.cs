...
/// JA: CTG governance DTO を replay-safe な metadata dictionary に書き出します。
/// </summary>
public sealed class CtgReplayMetadataWriter
{
    ...
    /// JA: replay metadata writer を初期化します。
    /// </summary>
    ...
    /// JA: step governance trace を metadata に書き出します。
    /// </summary>
    ...
    /// JA: trajectory gate result を metadata に書き出します。
    /// </summary>
