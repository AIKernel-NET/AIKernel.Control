...
/// JA: CTG diagnostics 用に control state snapshot を捕捉し、必要に応じて転送します。
/// </summary>
public sealed class CtgControlStateObserver : IControlStateObserver
{
    ...
    /// JA: CTG control state observer を初期化します。
    /// </summary>
    ...
    /// JA: control state snapshot を捕捉し、必要に応じて転送します。
    /// </summary>
