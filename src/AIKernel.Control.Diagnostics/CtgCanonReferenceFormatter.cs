...
/// [EN] Documents this public package API member. [JA] diagnostics output 用に CTG CanonReference を整形します。
/// </summary>
public sealed class CtgCanonReferenceFormatter
{
    /// <summary>
    /// EN: Formats a canon reference as a stable compact string.
    /// [EN] Documents this public package API member. [JA] CanonReference を安定した compact string として整形します。
    /// </summary>
