...
/// [EN] Documents this public package API member. [JA] replay と diagnostics view 用に CTG reject reason を整形します。
/// </summary>
public sealed class CtgRejectReasonFormatter
{
    /// <summary>
    /// EN: Formats a reject reason as a compact diagnostic string.
    /// [EN] Documents this public package API member. [JA] reject reason を簡潔な diagnostic string として整形します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] reject reason kind を metadata 用の uppercase snake case で整形します。
    /// </summary>
