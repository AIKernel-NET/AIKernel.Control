...
/// [EN] Documents this public package API member. [JA] emulator scenario 用の決定論的な mock council vote output を作成します。
/// </summary>
public sealed class CtgMockCouncilEvaluator
{
    /// <summary>
    /// EN: Creates provider vote outputs for the three CTG councils.
    /// [EN] Documents this public package API member. [JA] CTG の 3 council 用 provider vote output を作成します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] 1 つの council 用 provider vote output を作成します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] 3 つの vote value から emulator scenario を作成します。
    /// </summary>
