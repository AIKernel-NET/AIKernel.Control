...
/// <summary>EN: Documentation for public API. JA: DeterministicNodeScheduler を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: ScheduleAsync を取得します。</summary>
