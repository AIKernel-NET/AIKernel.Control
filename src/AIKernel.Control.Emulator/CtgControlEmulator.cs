...
/// [EN] Documents this public package API member. [JA] Core evaluator と既存 emulator engine を通じて CTG Control scenario を実行します。
/// </summary>
public sealed class CtgControlEmulator : ICtgControlEmulator
{
    ...
    /// [EN] Documents this public package API member. [JA] CTG Control emulator を初期化します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] policy、trajectory、emulator surface を通じて CTG Control scenario を実行します。
    /// </summary>
    ...
    private sealed class RecordingObserver : IControlStateObserver
    {
        ...
        /// <summary>
        /// EN: Gets Snapshots.
        /// [EN] Documents this public package API member. [JA] Snapshots を取得します。
        /// </summary>

        public IReadOnlyList<ControlStateSnapshot> Snapshots => _snapshots;
        /// <summary>
        /// EN: Gets ObserveAsync.
        /// [EN] Documents this public package API member. [JA] ObserveAsync を取得します。
        /// </summary>
