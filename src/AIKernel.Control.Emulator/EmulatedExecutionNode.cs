...
/// <summary>EN: Documentation for public API. JA: EmulatedExecutionNode を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: EmulatedExecutionNode を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: FaultMessage を取得します。</summary>
