...
/// EN: Documentation for public API. JA: 決定論的な CTG Control emulator scenario を記述します。
/// </summary>
public sealed record CtgControlEmulatorScenario
{
    ...
    /// EN: Documentation for public API. JA: scenario が使用する execution graph を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: scenario が使用する control execution request を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: CTG policy adapter に供給する provider vote output を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: trajectory gate dry-run evaluation に使用する optional な step trace を取得します。
    /// </summary>
    public IReadOnlyList<StepGovernanceTrace>? TrajectorySteps { get; init; }

    /// <summary>
    /// EN: Gets scenario metadata.
    /// EN: Documentation for public API. JA: scenario metadata を取得します。
    /// </summary>
