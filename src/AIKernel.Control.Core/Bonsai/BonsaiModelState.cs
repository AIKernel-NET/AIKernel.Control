...
/// <summary>EN: Documentation for public API. JA: BonsaiModelState を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: BonsaiModelState を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Config を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Tokenizer を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Q1Weights を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ActivationBuffer を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: LogitsBuffer を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: MarkInitialized を実行します。</summary>
