...
/// JA: perception 由来 vote を既存 CTG Control coordinator へ orchestration します。
/// </summary>
public sealed class PerceptionCtgControlCoordinator
{
    ...
    /// JA: perception CTG Control coordinator を初期化します。
    /// </summary>
    ...
    /// JA: CTG Control 経由で Gate 評価を Core に委譲し、perception 由来 control signal を評価します。
    /// </summary>
