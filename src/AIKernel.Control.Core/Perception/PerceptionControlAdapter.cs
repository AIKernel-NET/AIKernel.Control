...
/// [EN] Documents this public package API member. [JA] Gate logic を実行せず perception 由来 signal を provider vote output に変換します。
/// </summary>
public sealed class PerceptionControlAdapter
{
    /// <summary>
    /// EN: Adapts perception signals into CTG provider vote outputs.
    /// [EN] Documents this public package API member. [JA] perception signal を CTG provider vote output に変換します。
    /// </summary>
