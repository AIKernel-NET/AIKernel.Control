...
/// EN: Documentation for public API. JA: perception-to-CTG Control orchestration service を登録します。
/// </summary>
public static class PerceptionControlServiceCollectionExtensions
{
    ...
    /// EN: Documentation for public API. JA: perception execution Provider を登録せず perception Control adapter を追加します。
    /// </summary>
