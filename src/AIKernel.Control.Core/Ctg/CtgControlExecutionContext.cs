...
/// EN: Documentation for public API. JA: CTG Control policy 評価の実行状態を保持します。
/// </summary>
public sealed record CtgControlExecutionContext
{
    /// <summary>
    /// EN: Gets the governance operation identifier.
    /// EN: Documentation for public API. JA: governance operation 識別子を取得します。
    /// </summary>
    public string OperationId { get; init; } = string.Empty;

    /// <summary>
    /// EN: Gets the policy step identifier.
    /// EN: Documentation for public API. JA: policy step 識別子を取得します。
    /// </summary>
    public string StepId { get; init; } = string.Empty;

    /// <summary>
    /// EN: Gets the execution graph being evaluated.
    /// EN: Documentation for public API. JA: 評価対象の execution graph を取得します。
    /// </summary>
    public IExecutionGraph? Graph { get; init; }

    /// <summary>
    /// EN: Gets the control execution request being evaluated.
    /// EN: Documentation for public API. JA: 評価対象の control execution request を取得します。
    /// </summary>
    public ControlExecutionRequest? Request { get; init; }

    /// <summary>
    /// EN: Gets provider vote outputs to normalize into council votes.
    /// EN: Documentation for public API. JA: council vote に正規化する provider vote 出力を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: 生成される governance DTO に付与する CanonReference を取得します。
    /// </summary>
    ...
    /// EN: Documentation for public API. JA: 優先 sensor から供給される任意の retry intent carrier を取得します。
    /// </summary>
    public CtgRetryIntentCarrier? RetryIntent { get; init; }

    /// <summary>
    /// EN: Gets the correlation identifier.
    /// EN: Documentation for public API. JA: correlation 識別子を取得します。
    /// </summary>
    public string? CorrelationId { get; init; }

    /// <summary>
    /// EN: Gets the trace identifier.
    /// EN: Documentation for public API. JA: trace 識別子を取得します。
    /// </summary>
    public string? TraceId { get; init; }

    /// <summary>
    /// EN: Gets the observed timestamp used by generated DTOs.
    /// EN: Documentation for public API. JA: 生成される DTO で使用する観測時刻を取得します。
    /// </summary>
    public DateTimeOffset? ObservedAt { get; init; }

    /// <summary>
    /// EN: Gets control metadata copied into generated governance DTOs.
    /// EN: Documentation for public API. JA: 生成される governance DTO にコピーする Control metadata を取得します。
    /// </summary>
