...
/// [EN] Documents this public package API member. [JA] Control policy 境界で skeleton の step governance trace を組み立てます。
/// </summary>
public sealed class CtgStepTraceAssembler
{
    /// <summary>
    /// EN: Creates a step governance trace from council and decision gate DTOs.
    /// [EN] Documents this public package API member. [JA] council DTO と decision gate DTO から step governance trace を作成します。
    /// </summary>
