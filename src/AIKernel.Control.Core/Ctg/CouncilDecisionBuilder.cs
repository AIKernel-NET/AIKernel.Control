...
/// [EN] Documents this public package API member. [JA] 正規化済み council vote から council decision を構築します。
/// </summary>
public sealed class CouncilDecisionBuilder
{
    ...
    /// [EN] Documents this public package API member. [JA] Gate logic を適用せず council evaluation result を構築します。
    /// </summary>
